      ...
      <div className="container max-w-7xl mx-auto py-6 px-4 md:py-10 md:px-6 mt-0 md:mt-0">
        <div className="flex flex-col items-center justify-center py-16 text-center max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {recentDecks.map((deck) => (
                  <Link href={`/decks/${deck.id}`} key={deck.id}>
                    <Card className="group border cursor-pointer border-border/50 bg-card/30 backdrop-blur-sm hover:bg-card/60 transition-all duration-300 hover:border-primary/30">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center w-full max-w-md mx-auto">
            <Link href="/library" className="w-full sm:w-1/2">
              <Button
                size="lg"
                variant="default"
            ...
            <Link href="/explore" className="w-full sm:w-1/2">
              <Button
                size="lg"
                variant="outline"
