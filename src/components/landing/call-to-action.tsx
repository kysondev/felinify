        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="flex justify-center">
            <div className="w-full">
              <div className="group relative bg-card border border-border rounded-xl p-12 overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-start justify-between gap-10 md:flex-row">
                  ...
                  <div className="md:w-1/2">
                    ...
                    <p className="text-muted-foreground text-lg">
                      Master any subject with AI-enhanced flashcards, smart
                      repetition, and a distraction-free study experience built
