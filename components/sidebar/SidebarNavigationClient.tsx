...
export const SidebarNavigationClient = ({ collapsed = false }: SidebarNavigationClientProps) => {
    const pathname = usePathname()
    const isActive = (path: string) => pathname === path ? "bg-white text-primary border border-[#E7E6E6]" : "text-muted-foreground border-transparent hover:text-primary"
